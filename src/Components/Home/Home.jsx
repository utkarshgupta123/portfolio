    ...
    <div className="main">
      <div className="page-top">
        <div className="page-top-content">
          <h1 className="navName">Hi, I am Utkarsh Gupta</h1>
      ...
      <div className="portfolio" id="portfolio-id">
        ...
        <div className="portfolio-grid">
          <div>
            <a href="https://utkarshgupta123.github.io/digital-clock-js/" rel="noreferrer" target="_blank">
              <img className="portfolio-grid-item" src={clock} alt="" />
            </a>
          </div>
          <div>
            <a href="https://wondrous-sunshine-bbb3b8.netlify.app/" rel="noreferrer" target="_blank"><img className="portfolio-grid-item" src={blog} alt="" /></a>
          </div>
          <div>
            <a href="https://github.com/utkarshgupta123/ecomfrontend.git" rel="noreferrer" target="_blank"><img className="portfolio-grid-item" src={miStore} alt="" /></a>

          </div>
          <div>
            <a href="https://github.com/utkarshgupta123/ecomfrontend.git" rel="noreferrer" target="_blank"><img className="portfolio-grid-item" src={netflix} alt="" /></a>
          </div>
          <div>
            <a href="https://utkarshgupta123.github.io/cssproject2/" rel="noreferrer" target="_blank"><img className="portfolio-grid-item" src={todo} alt="" /></a>
