    ...
    <div className="contact" id="contact-id">
      ...
      <div className="contact-flex">
        ...
        <div className="contact-form">
          ...
          <form action="https://formsubmit.co/utkarshgupta12400@gmail.com" method="POST">
            <label htmlFor="fname">Full Name<span>*</span></label>
            <br />
            <input type="text" id="fname" name="Name" className="inpStyle" required/>
            <br /> <br />

            <label htmlFor="pnum">Phone Number<span>*</span></label>
            <br />
            <input type="text" placeholder="" id="pnum" name="Phone" className="inpStyle" />
            <br /> <br />
